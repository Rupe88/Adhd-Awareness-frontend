      ...
      <div className=" bg-white dark:bg-gray-900 min-h-screen flex items-center justify-center">
        <div className="container mx-auto px-8 py-16 flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-1/2 mb-8 md:mb-0 pr-0 md:pr-8">
            <h1 className="text-4xl font-bold mb-6 text-pink-600 dark:text-pink-400 mt-4">
              Understanding ADHD
            </h1>
            <p className="text-lg text-gray-700 dark:text-gray-300 mb-4">
              Attention Deficit Hyperactivity Disorder (ADHD) is a
              neurodevelopmental condition that affects both children and
              adults. Its characterized by difficulties with focus,
              hyperactivity, and impulsivity.
            </p>
            <p className="text-lg text-gray-700 dark:text-gray-300 mb-4">
              Living with ADHD can be challenging, but with proper support and
              strategies, individuals can thrive and harness their unique
              strengths.
            </p>
